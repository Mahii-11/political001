...
const slides = [
  ...
  },
  {
    id: 2,
    title:
      "সম্প্রীতিমূলক সমন্বিত রাষ্ট্রসত্তা (Rainbow Nation) প্রতিষ্ঠা ও National Reconciliation Commission (জাতীয় সমন্বয় কমিশন) গঠন:",
    details:
  ...
  },
  {
    id: 3,
    title:
      "নির্বাচনকালীন দল নিরপেক্ষ তত্ত্বাবধায়ক সরকার ব্যবস্থার পুনঃপ্রবর্তনঃ ",
    details:
  ...
  },
  {
    ...
    details:
      "অর্থনৈতিক ন্যায়বিচার নিশ্চিত করিবার লক্ষ্যে বিশেষজ্ঞ অর্থনীতিবিদ ও গবেষক, অভিজ্ঞ ব্যাংকার, কর্পোরেট নেতা, প্রশাসনিক অভিজ্ঞতা সম্পন্ন ব্যক্তি সমন্বয়ে একটি “অর্থনৈতিক সংস্কার কমিশন” গঠন করা হইবে। মুক্তিযুদ্ধের মূলমন্ত্র সাম্য, মানবিক মর্যাদা ও সামাজিক ন্যায়বিচারের নিরিখে প্রবৃদ্ধির সুফল সুষম বণ্টনের মাধ্যমে ধনী-দরিদ্রের বৈষম্য দূরীকরণ করা হইবে। উপরোক্ত সাংবিধানিক সংস্কার কমিশন, প্রশাসনিক সংস্কার কমিশন, জুডিশিয়াল কমিশন, মিডিয়া কমিশন এবং অর্থনৈতিক সংস্কার কমিশনগুলি সুনির্দিষ্ট সময়ের মধ্যে স্ব-স্ব প্রতিবেদন দাখিল করিবে যেন সংশ্লিষ্ট সুপারিশ সমূহ দ্রুত বাস্তবায়ন করা সম্ভব হয়। ",
  },
  {
    id: 16,
  ...
  details: "দারিদ্র বিমোচন, ক্ষুধামুক্তি ও নারীর স্বাবলম্বীতায় প্রতি মাসে ২০০০-২৫০০ টাকার মাসিক সহায়তা অথবা খাদ্য সুবিধা প্রদান।",
  },
   {
  id: 33,
  title: "কৃষক কার্ড",
  details: "ন্যায্য মূল্যে সার, বীজ, কিটনাশক। সরকারি ভর্তুকী প্রনোদনা, কৃষি যন্ত্রপাতি সুবিধা, সেচ সুবিধা, সহজ শর্তে কৃষি ঋণ, কৃষি বীমা, ন্যায্য মূল্যে কৃষিপণ্য বিক্রয় সুবিধা ও প্রশিক্ষণ।",
  },
   {
  id: 34,
  title: "স্বাস্থ্য",
  details: "মা ও শিশুর পূর্ণাঙ্গ স্বাস্থ্য সেবা, ঔষধ ও ভ্যাকসিন সরবরাহের নেটওয়ার্ক, মশাবাহিত রোগ নির্মূল, রোগপ্রতিরোধ ও স্বাস্থ্য সচেতনতা, স্বাস্থ্যকর্মী নিয়োগ, দূর্নীতি মুক্ত স্বাস্থ্য সেবা।",
  },
   {
  id: 35,
  title: "শিক্ষা",
  details: "ওয়ান টিচার, ওয়ান ট্যাব। মাল্টিমিডিয়া ক্লাসরুম স্থাপন, লার্নিং উইথ হ্যাপিনেস, সবার জন্য কারিগরি শিক্ষা বাধ্যতামূলক, তৃতীয় ভাষা শিক্ষা, সু-শিক্ষায় মেধাবী শিক্ষক।",
  },
   {
  id: 36,
  title: "ক্রীড়া",
  details: "খেলাধুলাকে পেশা হিসেবে প্রতিষ্ঠা, ৪র্থ শ্রেণি থেকে খেলাধুলা বাধ্যতামূলক করার চেষ্টা করবো।",
  },
   {
  id: 37,
  title: "কর্মসংস্থা",
  details: "মেধাভিত্তিক সরকারি নিয়োগ, তথ্যপ্রযুক্তিতে নতুন শিল্প, সবার জন্য ইন্টারনেট সুবিধা, বিদেশে কর্মসংস্থানের জন্য ভাষা শিক্ষা ও দক্ষতার জন্য প্রশিক্ষণ, ক্ষুদ্র ও মাঝারি উদ্যোক্তাদের সহায়তা, উন্নয়ন প্রকল্পে কর্মসংস্থান সৃষ্টি।",
  },
   {
  id: 38,
  title: "ধর্মীয় নেতাদের উন্নয়ন সেবা",
  details: "খতিব, ইমাম ও মুয়াজ্জিম সাহেবদের মাসিক সম্মানী প্রদান ও ধর্মীয় উৎসব ভাতা প্রদান। ইমাম ও মুয়াজ্জিনদের জন্য কল্যান ট্রাস্ট এবং সামাজিক ও রাষ্ট্রীয় মর্যাদা বৃদ্ধির উদ্যোগ। অন্যান্য ধর্মের (হিন্দু, বৌদ্ধ, খ্রিস্টান) উপাসনালয়ের মাসিক সম্মানী ও উৎসব ভাতা প্রদান।",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {slides.map((slide) => (
              ...
              >
                <div
                  className="relative h-full rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300
            hover:-translate-y-2 hover:shadow-xl hover:border-emerald-300"
              ...
              bg-gradient-to-br from-emerald-200/30 via-transparent to-rose-200/30"
                  />
